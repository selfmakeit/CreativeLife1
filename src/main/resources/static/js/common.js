...
function login_form_submit() {
    $.ajax({
        cache: !1, type: "POST", url: "/user/login/", data: $("#login_form").serialize(), beforeSend: function () {
            $("#login_btn").html("登录中..."), $("#login_btn").attr("disabled", "disabled")
        }, success: function (e) {
            if (e.account_l) $("#login-form-tips").html(e.account_l).show(500), $("#id_account_l").focus(); else if (e.password_l) $("#login-form-tips").html(e.password_l).show(500), $("#id_password_l").focus(); else {
